...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork, passing, and match strategy on the field",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["mia@mergington.edu", "noah@mergington.edu"]
    },
    "Swim Club": {
        "description": "Build endurance and technique with pool workouts and relay training",
    ...
    "Debate Team": {
        "description": "Practice research, public speaking, and argumentation skills",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["chloe@mergington.edu", "alex@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Design and build robots while solving engineering challenges",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
